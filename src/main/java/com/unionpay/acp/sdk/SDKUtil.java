...
public class SDKUtil {
    ...
    public static String signRsa(Map<String, String> data, String certPath, String certPwd, String encoding) {
        try{
            ...
            return Base64.getEncoder().encodeToString(SecureUtil.getSignature(CertUtil.getSignCertPrivateKeyByStoreMap(certPath, certPwd), sha1Hex.getBytes()));
        } catch (Exception e) {
    ...
    public static String signRsa2(Map<String, String> data, String certPath, String certPwd, String encoding) {
        try {
            ...
            return Base64.getEncoder().encodeToString(SecureUtil.getSignatureSHA256(CertUtil.getSignCertPrivateKeyByStoreMap(certPath, certPwd), sha256Hex.getBytes()));
        } catch (Exception e) {
    ...
    public static boolean verifyRsa(Map<String, String> resData, PublicKey pubKey, String encoding) {
        try{
            ...
            return SecureUtil.verifySignature(pubKey,
                    ...
                    Base64.getDecoder().decode(stringSign));
        } catch (Exception e) {
